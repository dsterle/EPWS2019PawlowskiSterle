        ...
        infos: [
            {
                ...
                audioSrc: require("../assets/audio/painting-1/2-Kurzbeschreibung.mp3")
            },
            {
                id: 1,
                name: "Provenienz",
                ...
                audioSrc: require("../assets/audio/painting-1/3-Provenienz.mp3")
            },
            {
                id: 2,
                name: "Maße",
                inhalt: "Maße Bildträger: 60,3 x 45,5 x 0,45-0,55 cm (Format nahezu original)",
                audioSrc: require("../assets/audio/painting-1/4-Maße.mp3")
            },
            {
                id: 3,
                name: "Material/Technik",
                inhalt: "Malerei auf Fichtenholz (Picea sp.)",
                audioSrc: require("../assets/audio/painting-1/5-MaterialTechnik.mp3")
            },
            {
                id: 4,
                name: "Beschriftung",
                ...
                audioSrc: require("../assets/audio/painting-1/6-Beschriftung.mp3")
            },
            {
                id: 5,
                ...
                audioSrc: require("../assets/audio/painting-1/7-Ausstellungsgeschichte.mp3")
            }
        ]
    },
    {
        ...
        infos: [
            {
                ...
                audioSrc: require("../assets/audio/painting-2/2-Kurzbeschreibung.mp3")
            },
            {
                id: 1,
                name: "Provenienz",
                inhalt: "Sammlung Charles I, König von England\n- Familie Locker-Lampson, England \n- Baron of Sandys, England\n- Kunsthandel  A. -G., Luzern, Julius Böhler gall.\n- 1925 durch Reinhart erworben",
                audioSrc: require("../assets/audio/painting-2/3-Provenienz.mp3")
            },
            {
                id: 2,
                name: "Maße",
                inhalt: "Maße Bildträger: 60,2-60,1 x 45,5-45 x 0,45-0,55 cm (Format nahezu original)",
                audioSrc: require("../assets/audio/painting-2/4-Maße.mp3")
            },
            {
                id: 3,
                name: "Material/Technik",
                inhalt: "Malerei auf Fichtenholz (Picea sp.)",
                audioSrc: require("../assets/audio/painting-2/5-MaterialTechnik.mp3")
            },
            {
                id: 4,
                name: "Ausstellungsgeschichte",
                inhalt: "Bern 1939-1940, Nr. 62-63, Taf. III\nZürich 1940-1941, Nr. 39-40, Taf. XI-XII\nWinterthur 1955, Nr. 42-43, Taf. V.\nKronach 1994, Nr. 118",
                audioSrc: require("../assets/audio/painting-2/6-Ausstellungsgeschichte.mp3")
            }
        ]
    },
    {
        ...
        infos: [
            {
                ...
                audioSrc: require("../assets/audio/painting-3/2-Kurzbeschreibung.mp3")
            },
            {
                id: 1,
                name: "Provenienz",
                ...
                audioSrc: require("../assets/audio/painting-3/3-Provenienz.mp3")
            },
            {
                id: 2,
                name: "Maße",
                ...
                audioSrc: require("../assets/audio/painting-3/4-Maße.mp3")
            },
            {
                id: 3,
                name: "Material/Technik",
                inhalt: "Malerei auf Lindenholz (Tilia sp.)\n[Klein, Bericht 2013]\n[P. Klein, Bericht von 1980]",
                audioSrc: require("../assets/audio/painting-3/5-MaterialTechnik.mp3")
            },
            {
                id: 4,
                name: "Ausstellungsgeschichte",
                ...
                audioSrc: require("../assets/audio/painting-3/6-Ausstellungsgeschichte.mp3")
            }
        ]
    }
]