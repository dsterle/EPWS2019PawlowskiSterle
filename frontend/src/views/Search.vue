                        ...
                        infos: [
                            {
                                id: 0,
                                name: "Kurzbeschreibung",
                                inhalt: "Brustbildnis der Frau des Historiographen Dr. Johannes Cuspinian (Spiessheimer)\nTeil eines Diptychons (Gegenstück zum Bildnis des Johannes Cuspinian)",
                                audioSrc: "https://raw.githubusercontent.com/dsterle/EPWS2019PawlowskiSterle/za-FrontendBackend-Database/audiofiles/painting-2/2-Kurzbeschreibung.mp3",
                            },
                            {
                                id: 1,
                                name: "Provenienz",
                                inhalt: "Sammlung Charles I, König von England\n- Familie Locker-Lampson, England \n- Baron of Sandys, England\n- Kunsthandel  A. -G., Luzern, Julius Böhler gall.\n- 1925 durch Reinhart erworben",
                                audioSrc: "https://raw.githubusercontent.com/dsterle/EPWS2019PawlowskiSterle/za-FrontendBackend-Database/audiofiles/painting-2/3-Provenienz.mp3",
                            },
                            {
                                id: 2,
                                name: "Maße",
                                inhalt: "Maße Bildträger: 60,2-60,1 x 45,5-45 x 0,45-0,55 cm (Format nahezu original)",
                                audioSrc: "https://raw.githubusercontent.com/dsterle/EPWS2019PawlowskiSterle/za-FrontendBackend-Database/audiofiles/painting-2/4-Maße.mp3",
                            },
                            {
                                id: 3,
                                name: "Material/Technik",
                                inhalt: "Malerei auf Fichtenholz (Picea sp.)",
                                audioSrc: "https://raw.githubusercontent.com/dsterle/EPWS2019PawlowskiSterle/za-FrontendBackend-Database/audiofiles/painting-2/5-MaterialTechnik.mp3",
                            },
                            {
                                id: 4,
                                name: "Ausstellungsgeschichte",
                                inhalt: "Bern 1939-1940, Nr. 62-63, Taf. III\nZürich 1940-1941, Nr. 39-40, Taf. XI-XII\nWinterthur 1955, Nr. 42-43, Taf. V.\nKronach 1994, Nr. 118",
                                audioSrc: "https://raw.githubusercontent.com/dsterle/EPWS2019PawlowskiSterle/za-FrontendBackend-Database/audiofiles/painting-2/6-Ausstellungsgeschichte.mp3",
                            }
                        ]
                    },
                    {
                        ...
                        infos: [
                            ...
                            },
                            {
                                ...
                                audioSrc: "https://raw.githubusercontent.com/dsterle/EPWS2019PawlowskiSterle/za-FrontendBackend-Database/audiofiles/painting-3/6-Ausstellungsgeschichte.mp3",
                            }
                        ]
                    }
                ],
        ...
        methods: {
            findPaintingsByTitle(title) {
                ...
                this.paintingList.forEach(function (elm) {
                    ...
                    if (elmTitle.substring(0, title.length) === title)
                        findings.push(elm);
                });
                return findings;
            },
            findPaintingsByDate(date) {
                ...
                this.paintingList.forEach(function (elm) {
                    ...
                    if (datedString.substring(0, date.length) === date)
                        findings.push(elm);
                });
                return findings;
            },
